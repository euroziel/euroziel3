      ...
      <div className="flex flex-col relative h-14">
        ...
        >
          ...
          <g fontFamily="system-ui, -apple-system, sans-serif" fontWeight="900" fontSize="38" letterSpacing="-1">
            ...
            <text x="130" y="52" className="logo-gold font-sans">Z</text>
            <text x="156" y="52" className="logo-blue font-sans">IEL</text>
          </g>
          ...
          {/* Removed malformed style block and duplicate text. Font should be handled via CSS/tailwind. */}
        </svg>
        {/* Subtitle / Tagline below */}
        <div
          className="text-[8px] sm:text-[9px] font-bold tracking-[0.25em] pl-9 uppercase"
          style={{
