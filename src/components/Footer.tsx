      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="col-span-1 md:col-span-3 text-left">
            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-800 dark:text-slate-100 mb-4">
              Explore EuroZiel
            </h4>
          ...
          <div className="col-span-1 md:col-span-2 text-left">
            ...
            <div className="space-y-4 text-xs font-sans">
              <div>
                <div className="font-extrabold text-slate-700 dark:text-slate-300">Yuvasri Jagadeesan</div>
                <div className="text-[10px] text-[#e5a800] uppercase mt-0.5">Academic Strategy Lead</div>
              </div>
              <div>
                <div className="font-extrabold text-slate-700 dark:text-slate-300">Sarathkumar Venkateshwaran</div>
        ...
        <div className="border-t border-slate-200/50 dark:border-slate-800 pt-8 text-[11px] font-sans leading-relaxed text-slate-400 max-w-4xl mr-auto text-left space-y-3">
        ...
        <div className="border-t border-slate-200/40 dark:border-slate-900 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
