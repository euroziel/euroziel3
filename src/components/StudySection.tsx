    ...
    <div className="space-y-24 md:space-y-36 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-4 space-y-12">
        <div className="text-left max-w-2xl">
          ...
          <h3 className="text-2xl md:text-3xl font-extrabold font-sans">Facts That Matter</h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat, idx) => (
            <div 
              key={idx}
              className="p-6 rounded-sm border border-slate-200/50 dark:border-slate-800 bg-white dark:bg-slate-950 text-left space-y-3 shadow-premium hover:border-gold hover:shadow-premium transition-all relative overflow-hidden group border-b-2 border-b-navy"
            >
              ...
              <div>
                <h4 className="text-sm font-bold text-slate-800 dark:text-slate-200">{stat.label}</h4>
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-2 leading-relaxed font-sans">{stat.desc}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="bg-slate-50/50 dark:bg-slate-950/50 py-20 px-4 border-y border-slate-100 dark:border-slate-900">
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {specialisations.map((spec, idx) => (
              <div 
                key={idx}
                className="p-6 rounded-sm border border-slate-200/50 dark:border-slate-800 bg-white dark:bg-slate-950 text-left space-y-4 shadow-premium hover:border-gold transition-all duration-300"
              >
                <div className="w-10 h-10 rounded-sm bg-slate-50 dark:bg-slate-900 border border-slate-200/40 dark:border-slate-800 flex items-center justify-center shrink-0 text-navy">
                  {spec.icon}
                </div>
                <div>
                  <h4 className="font-bold text-sm mb-2 text-slate-800 dark:text-slate-200">{spec.title}</h4>
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed font-sans">{spec.text}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-sm border border-slate-200/60 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 shadow-sm border-b-2 border-b-gold">
              ...
              <div className="p-4 rounded-sm border border-slate-200/60 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 shadow-sm border-b-2 border-b-navy">
          ...
          <div className="lg:col-span-6">
            <div className="p-6 md:p-8 rounded-sm border border-slate-200/50 dark:border-slate-800 bg-white dark:bg-slate-950/80 shadow-premium">
              <div className="text-left mb-6">
                <h4 className="font-bold text-navy uppercase tracking-widest text-[10px] mb-1">Global Employers</h4>
                <div className="text-base font-bold text-slate-800 dark:text-slate-100">Where EuroZiel Connected Students Work</div>
              ...
              <div className="flex flex-wrap gap-2 justify-start">
                {brandLogs.map((brand, bIdx) => (
                  <span 
                    key={bIdx}
                    className="px-4 py-2 bg-slate-50 dark:bg-slate-900 border border-slate-250 dark:border-slate-800 rounded-sm text-xs font-bold font-sans hover:text-[#e5a800] transition-colors"
                  >
                    {brand}
                  </span>
                ))}
      ...
      <section className="bg-slate-50/50 dark:bg-slate-950/50 py-20 px-4 border-y border-slate-100 dark:border-slate-900">
        <div className="max-w-4xl mx-auto text-left space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="rounded-sm border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-6 md:p-8 space-y-4 shadow-premium border-b-4 border-b-rose-500">
              ...
              <h3 className="text-lg font-bold font-sans">October Start (Main Intake)</h3>
              ...
              <div className="grid grid-cols-2 gap-3 text-xs border-t border-slate-100 dark:border-slate-900 pt-4">
                <div>
            ...
            <div className="rounded-sm border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-6 md:p-8 space-y-4 shadow-premium border-b-4 border-b-emerald-500">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-emerald-500 uppercase tracking-widest font-sans">Summer Intake</span>
              </div>
              <h3 className="text-lg font-bold font-sans">April Start</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed font-sans">
      ...
      <section className="max-w-4xl mx-auto px-4 text-center">
        <div className="p-8 md:p-12 rounded-sm border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-premium text-slate-800 dark:text-white space-y-6 border-b-4 border-b-gold">
          ...
          <h3 className="text-2xl md:text-3xl font-bold font-sans max-w-xl mx-auto text-slate-900 dark:text-white">
